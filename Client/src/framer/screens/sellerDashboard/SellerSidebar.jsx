...
import {warnToast} from '../../components/Toastify'
...
const SellerSideBar = () => {
  ...
  const navItems = [
    ...
    { name: "My Posts", icon: <MdPostAdd />, path: "posts" },
    { name: "Favourites", icon: <FaHeart />, path: "myfavourites" },
    { name: "My Reviews", icon: <MdReviews />, path: "myreviews" }
  ];
        ...
        {(isOpen || isLargeScreen) && (
          ...
          >
            ...
            <div className="p-4 text-center text-xs text-violet-200 border-t border-violet-800 dark:border-black">
              © {new Date().getFullYear()} WheelSpot
            </div>
          </motion.aside>
        )}
      </AnimatePresence>
